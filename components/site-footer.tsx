  ...
  return (
    <footer className="border-t border-slate-200 bg-muted">
      <div className="container px-4 md:px-6 py-8 md:py-12">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Button
                ...
                size="icon"
                asChild
                className="text-slate-default hover:text-primary hover:bg-white"
              >
                <Link href="#">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#" className="text-slate-default hover:text-primary">
                  Tech
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 border-t border-slate-200 pt-8 text-center text-sm text-slate-default">
          <p>© {new Date().getFullYear()} Aikins Select. All rights reserved.</p>
          <p className="mt-1">
            Aikins Select is reader-supported. When you buy through links on our site, we may earn an affiliate
            commission.
          </p>
        </div>
      </div>
